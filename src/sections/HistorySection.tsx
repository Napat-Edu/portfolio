        ...
        <section className="animate-fade-up">
            ...
            <div className="flex flex-col divide-y-2 mt-2">
                <div className="flex gap-4 py-4">
                    <img className="ww-80 h-80 rounded-md flex-shrink-0 flex-grow-0" src="ais-intern.jpg" alt="AIS intern history" />
                ...
                <div className="flex flex-row-reverse gap-4 py-4">
                    <img className="ww-80 h-80 rounded-md flex-shrink-0 flex-grow-0" src="newfounder.jpg" alt="Newfounder winner history" />
                    <div className="flex flex-col gap-2">
